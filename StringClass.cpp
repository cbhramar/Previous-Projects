...
struct  node // a struct to create a linked list of Strings
{
	String s;
	node *next;
	node()
...
void printlist(node *root, node *current) // prints the list in its current form
{
    current = root;
...
bool lessrank(const String & lhs, const String & rhs) // 'rank' refers to the dictionary order
{
...
// function to get the list in dictionary order
...
int main()
{
	...
	// sorting and an interactive demo
