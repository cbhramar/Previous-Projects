/*
 * File: FindEaster.cpp
 * The code finds Easter accurately for the 18th and 19th century by using a formula
 */
...
int main() {
    cout << "Welcome to ye olde Easter finding services for the 18th and 19th century. Please choose a year: \n";
    int year;
    cin >> year;
    string month;
    int day;
