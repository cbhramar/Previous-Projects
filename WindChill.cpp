/*
 * File: WindChill.cpp
 * This program was an exercise  for the Stanford Course CS106B
 * The program outputs in the form of a table the function WindChill which takes the temperature (in fahrenheit)
 * and the speed of the wind (in miles/hr) as parameters and returns a value that suggests (in relative terms) how 
 * cold a person will supposedly feel standing outside at the given temperature and wind speed
 */
#include <iostream>
#include <cmath>
#include <cstdlib>
