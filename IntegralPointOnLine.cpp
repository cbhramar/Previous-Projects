/*
 * File: IntegralPointOnLine.cpp
 * This program takes in the coefficients of a linear equation and outputs integral solutions of the equation, if any
 */
...
int main() {
    int x, y;
    int a, b, c;
    cout << "Enter the coefficeients a, b, c of the formula a*x + b*y = c:" << endl;
    cin >> a >> b >> c;
    if (c%gcd(a, b) == 0) {
