/*
 * File: RandomTrialStats.cpp
 * The program simulates a number of random trials in a uniform distribution between 0 and 1
 * and returns their average and RMS values to the user
 */
