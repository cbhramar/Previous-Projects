/*
 * File: SubsetSum.cpp
 * Program to check whether a target can be written as a sum of elements of an array provided by the user
 */
...
int main() {
    while (true) {
        int veclength;
        cout << "Enter the length of your vector (or enter q to quit):" << endl;
        cin >> veclength;
